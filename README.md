...
```javascript
import setLowWord from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint64-base-set-low-word@esm/index.mjs';
```
...
```javascript
import getLowWord from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint64-base-get-low-word@esm/index.mjs';
